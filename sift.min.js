!(function(t, n) {
  ...
  return (function(t) {
    ...
    function(t, n, e) {
      ...
      Object.defineProperty(n, "__esModule", { value: !0 }),
        (n.typeChecker = function(t) {
          var e = "[object " + t + "]";
          return function(t) {
            return n.getClassName(t) === e;
          };
        }),
        (n.getClassName = function(t) {
        ...
        (n.hasNestedProperty = function(t, n) {
          var e = String(n).split("."),
            r = t;
          if (1 === e.length) return r.hasOwnProperty(n);
          for (var o = 0, i = e.length - 1; o < i; o++)
            if (!(r = r[e[o]])) return !1;
          return r.hasOwnProperty(e[e.length - 1]);
        }),
        (n.nope = function() {
          return !1;
        });
    ...
    function(t, n, e) {
      ...
      (n.NestedOperation = f),
        (n.createTester = function(t, e) {
          if (t instanceof Function) return t;
          if (t instanceof RegExp)
            return function(n) {
              return "string" == typeof n && t.test(n);
            };
          var r = n.comparable(t);
          return function(t) {
            return e(r, n.comparable(t));
          };
        }),
        (n.comparable = function(t) {
          return t instanceof Date
